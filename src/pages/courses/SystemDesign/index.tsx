...
const index = () => {
  ...
  useEffect(() => {
    if (includes(get(userInfo, "courses_enrolled", 0), "2")) {
        ...
        <div className="px-3 px-lg-0">
            ...
            <div className="points-wrap">
              ...
              <div className="points">
                ...
                <p>
                  ...
                  design approaches, architectural patterns on the latest
          ...
          <div className="midDescription-container">
            ...
            <p className="descriptiontext">
              Have you ever wondered what makes the website like Google,
              Facebook, Netflix are available to us 24 * 7? <br />
              ...
              application/system on which these tech products are built. They
              all have a very solid foundation at their core. It is very
              important for software companies to be functional all the time in
              today’s world. It's hard to imagine even a single minute today
              without these tools. <br />
              And that's becoming more of a skill, understanding how to keep
              your systems functional all the time. It is now considered a
              primary skill to have when you are preparing for a software
              interview or trying to build a system for your organization or for
              your own product. <br />
              ...
              in the 2nd part, you will apply them in real-world software
              systems via comprehensive case studies keeping in mind all the
              low-level design principles used in the industry as well.
            </p>
          </div>
