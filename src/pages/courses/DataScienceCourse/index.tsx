  ...
  const faqItems = [
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> What is Data Science
          </div>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Variables and Inputs
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Type Conversion
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Strings
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Condional Statements
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Lists and Tuples
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Dictionaries
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Functions & Modules
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Read & Write Files
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Classes and Objects
          </div>
    ...
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Introduction to Numpy
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Basic Array Operations
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Slicing/Stacking Arrays with
            Boolean Arrays
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Iterate array using nditer
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/article.svg" /> DataFrames and Series Basics
          </div>
          <div className="svg-feature">
            <img src="/svg/article.svg" /> Indexes
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Filtering
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Updating Rows and Columns
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Add/Remove Rows and Columns from
            DataFrames
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Sorting Data
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Grouping and Aggregating
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Reading/Writing Data to
            Different Sources
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> How Amul Beat its Competition
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> How Asian Painrs Built Monopoly
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Median, Mean, Mode, Percentile
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Standard Deviation and Mean
            Absolute Deviation
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Normal Distribution and Z score
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Log and Log Normal Distribution
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Machine Learning for data
            science in one shot{" "}
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> A real Machine Learning Problem
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> SQL for Data Science in one
            video
          </div>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Microsoft PowerBi Tutorial
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Project: Personal Finance
            Dasboard
          </div>
          <div className="svg-feature">
            <img src="/svg/youtubeblack.svg" /> Project: HR Data Analytics
            Dasboard
          </div>
        </div>
      ),
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The Course is structured for a total beginner, having no coding or computer science background. Following so will build a very strong foundation for a strong Data Science carrier."
        />
        ...
        <meta
          itemProp="image"
          content="https://i.ibb.co/mcTQyvF/Group-37.png"
        />
      ...
      <AuthLayout>
        <div className="toptitle-container">
          ...
          <div className="topright-sticky">
            ...
            <div className="wrapper">
              {checkEnrolled ? (
                <NextLink href="https://edloops.com/curriculum/1">
            ...
            <div className="svg-feature">
              <img src="/svg/video.svg" /> 36 Lectures
            </div>
            <div className="svg-feature">
        ...
        <div className="topdescription">
          ...
          <h3 className="cont">
            This is a beginner-friendly self-paced curated course for Data
            Science aimed at providing an exclusive and crisp introduction to
            Data Science. It covers most of the topics necessary to start a
            carrier as a data science analyst, from scratch assuming no prior
            knowledge.
          </h3>
          <div className="svg">
            <div className="stat">
